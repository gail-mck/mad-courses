...
- d-blocks appear in their own section at the bottom of each grade column, separate from academic courses
- d-blocks with multiple seasons (like Dance) have season toggle buttons so you can pick which seasons you're doing
- courses updated to reflect the 2026–2027 Madeira Course Catalog
...
CSS :has() selector, used to hide the d-block section when empty without js:
https://developer.mozilla.org/en-US/docs/Web/CSS/:has

### data
Madeira Course Catalog 2026–2027 (PDF) has all course data, graduation requirements, D-block rules, co-curriculum descriptions. Used Claude AI to extract the data from PDF into JSON.

## testing

tested on macOS (Chrome) and on Windows 11 via a UTM virtual machine on the same mac. everything looked correct.

## notes to self
- confirm the rotation years for Linear Algebra / Multivariable Calc / Differential Equations
- check which d-blocks are counted as team and movement, set manually
